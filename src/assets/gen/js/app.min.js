...
!function t(e,n,r){function a(o,l){if(!n[o]){if(!e[o]){var c="function"==typeof require&&require;if(!l&&c)return c(o,!0);if(i)return i(o,!0);var u=new Error("Cannot find module '"+o+"'");throw u.code="MODULE_NOT_FOUND",u}var h=n[o]={exports:{}};e[o][0].call(h.exports,function(t){var n=e[o][1][t];return a(n?n:t)},h,h.exports,t,e,n,r)}return n[o].exports}for(var i="function"==typeof require&&require,o=0;o<r.length;o++)a(r[o]);return a}({1:[function(t,e,n){"use strict";function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function a(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var i=function(){function t(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}}(),o=function(t,e,n){for(var r=!0;r;){var a=t,i=e,o=n;l=u=c=void 0,r=!1,null===a&&(a=Function.prototype);var l=Object.getOwnPropertyDescriptor(a,i);if(void 0!==l){if("value"in l)return l.value;var c=l.get;return void 0===c?void 0:c.call(o)}var u=Object.getPrototypeOf(a);if(null===u)return void 0;t=u,e=i,n=o,r=!0}},l=t("./model"),c=new l.GCCIModel,u=function(t){function e(t){r(this,e),o(Object.getPrototypeOf(e.prototype),"constructor",this).call(this,t),this.moveNode=null}return a(e,t),i(e,[{key:"addChild",value:function(t){console.log("add child")}},{key:"addSibling",value:function(t,e){console.log("add sibling "+e)}},{key:"move",value:function(t){console.log("move")}},{key:"moveTo",value:function(t){}},{key:"NodeRowStyle",value:function(t){return{marginLeft:30*(l.GCCIModel.getDepth(t.path)-1)}}},{key:"render",value:function(){var t=this,e=this.props.data.map(function(e){return React.createElement("div",{style:t.NodeRowStyle(e),className:"node-row"},React.createElement("div",{className:"dropdown pull-left"},React.createElement("a",{className:"dropdown-toggle menu-action-icon action-handle","data-toggle":"dropdown"},React.createElement("i",{className:"glyphicon glyphicon-option-vertical"})),React.createElement("ul",{className:"dropdown-menu"},React.createElement("li",null,React.createElement("a",{onClick:t.addSibling.bind(t,e,"left")},React.createElement("i",{className:"glyphicon glyphicon-menu-up"}),"   add sibling above")),React.createElement("li",null,React.createElement("a",{onClick:t.addSibling.bind(t,e,"right")},React.createElement("i",{className:"glyphicon glyphicon-menu-down"}),"   add sibling below")),React.createElement("li",null,React.createElement("a",{onClick:t.addChild.bind(t,e)},React.createElement("i",{className:"glyphicon glyphicon-arrow-right rotate45"}),"   add child")),React.createElement("li",null,React.createElement("a",{onClick:t.move.bind(t.node)},React.createElement("i",{"class":"glyphicon glyphicon-move"}),"   move")))),React.createElement("span",{className:"node-title"},e.title))});return React.createElement("div",{className:"model-tree"},e)}}]),e}(React.Component);document.addEventListener("GCCIMODEL_READY",function(){React.render(React.createElement(u,{data:c.getTree()}),document.getElementById("mainContainer"))})},{"./model":2}],2:[function(t,e,n){"use strict";function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(n,"__esModule",{value:!0});var a=function(){function t(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}}(),i=function(){function t(){r(this,t),this.errors={NOT_READY:new Error("GCCIModel is not ready. Listen for 'GCCIMODEL_READY' event on 'document' object."),INVALID_MOVE:new Error("Cannot move node to one of its descendants.")},this.rootRef=new Firebase("https://gcci-model.firebaseio.com/"),this.nodes=[],this.isReady=!1,this.init()}return a(t,[{key:"init",value:function(){var t=this;this.rootRef.on("value",function(e){var n=e.val();if(t.nodes=[],null!==n){var r=!0,a=!1,i=void 0;try{for(var o,l=Object.keys(n)[Symbol.iterator]();!(r=(o=l.next()).done);r=!0){var c=o.value,u=n[c];u.id=c,t.nodes.push(u)}}catch(h){a=!0,i=h}finally{try{!r&&l["return"]&&l["return"]()}finally{if(a)throw i}}}t.isReady=!0,document.dispatchEvent(new CustomEvent("GCCIMODEL_READY"))})}},{key:"checkReady",value:function(){if(!this.isReady)throw this.errors.NOT_READY}},{key:"getNodeById",value:function(t){return this.checkReady(),this.nodes.find(function(e){return e.id===t})}},{key:"getRefById",value:function(t){return this.rootRef.orderByKey().equalTo(t).ref()}},{key:"getTree",value:function(){this.checkReady();var e=[],n=!0,r=!1,a=void 0;try{for(var i,o=this.nodes[Symbol.iterator]();!(n=(i=o.next()).done);n=!0){var l=i.value;if(1===t.getDepth(l.path)){this.dfs(l,e);break}}}catch(c){r=!0,a=c}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw a}}return e}},{key:"getChildren",value:function(e){var n=[],r=!0,a=!1,i=void 0;try{for(var o,l=this.nodes[Symbol.iterator]();!(r=(o=l.next()).done);r=!0){var c=o.value;t.getParentPath(c)===e.path&&n.push(c)}}catch(u){a=!0,i=u}finally{try{!r&&l["return"]&&l["return"]()}finally{if(a)throw i}}return n}},{key:"getDescendants",value:function(e){var n=[],r=!0,a=!1,i=void 0;try{for(var o,l=this.nodes[Symbol.iterator]();!(r=(o=l.next()).done);r=!0){var c=o.value;t.getPathAtDepth(c.path,t.getDepth(e.path))===e.path&&t.getDepth(c.path)>t.getDepth(e.path)&&n.push(c)}}catch(u){a=!0,i=u}finally{try{!r&&l["return"]&&l["return"]()}finally{if(a)throw i}}return n}},{key:"getParent",value:function(e){var n=t.getParentPath(e);return this.nodes.find(function(t){return t.path===n})}},{key:"getSiblings",value:function(e){var n=[],r=t.getParentPath(e),a=!0,i=!1,o=void 0;try{for(var l,c=this.nodes[Symbol.iterator]();!(a=(l=c.next()).done);a=!0){var u=l.value;r===t.getParentPath(u)&&n.push(u)}}catch(h){i=!0,o=h}finally{try{!a&&c["return"]&&c["return"]()}finally{if(i)throw o}}return n.sort(function(t,e){return t.path.localeCompare(e.path)}),n}},{key:"addChild",value:function(e,n){var r=t.calcPathAppend(e.path,t.indexToPath(this.getChildren(e).length+1));this.rootRef.push().set({title:n.title,uid:n.uid,path:r})}},{key:"addSibling",value:function(e,n,r){var a=this.getSiblings(e),i=t.getParentPath(e),o="";if("first"===n){o=t.calcPathAppend(i,t.indexToPath(1));var l=!0,c=!1,u=void 0;try{for(var h,d=a[Symbol.iterator]();!(l=(h=d.next()).done);l=!0){var f=h.value;this.updatePath(f,t.calcPathShift(f.path,1))}}catch(s){c=!0,u=s}finally{try{!l&&d["return"]&&d["return"]()}finally{if(c)throw u}}}else if("last"===n)o=t.calcPathAppend(i+t.indexToPath(a.length+1));else if("left"===n||"right"===n){o="left"===n?e.path:t.calcPathShift(e.path,1);var v=!0,y=!1,p=void 0;try{for(var g,m=a[Symbol.iterator]();!(v=(g=m.next()).done);v=!0){var f=g.value;t.getPathIndex(f.path)>=t.getPathIndex(o)&&this.updatePath(f,t.calcPathShift(f.path,1))}}catch(s){y=!0,p=s}finally{try{!v&&m["return"]&&m["return"]()}finally{if(y)throw p}}}if(""===o)throw"Invalid path";this.rootRef.push().set({title:r.title,uid:r.uid,path:o})}},{key:"remove",value:function(e){var n=this.getDescendants(e),r=this.getSiblings(e),a=t.getPathIndex(e.path),i=!0,o=!1,l=void 0;try{for(var c,u=n[Symbol.iterator]();!(i=(c=u.next()).done);i=!0){var h=c.value;this.getRefById(h.id).remove()}}catch(d){o=!0,l=d}finally{try{!i&&u["return"]&&u["return"]()}finally{if(o)throw l}}this.getRefById(e.id).remove();var f=!0,s=!1,v=void 0;try{for(var y,p=r[Symbol.iterator]();!(f=(y=p.next()).done);f=!0){var g=y.value;t.getPathIndex(g.path)>a&&this.updatePath(g,t.calcPathShift(g.path,-1))}}catch(d){s=!0,v=d}finally{try{!f&&p["return"]&&p["return"]()}finally{if(s)throw v}}}},{key:"move",value:function(e,n,r){var a=e.path,i=this.getSiblings(e),o=!0,l=!1,c=void 0;try{for(var u,h=this.getDescendants(e)[Symbol.iterator]();!(o=(u=h.next()).done);o=!0){var d=u.value;if(d.id===n.id)throw this.errors.INVALID_MOVE}}catch(f){l=!0,c=f}finally{try{!o&&h["return"]&&h["return"]()}finally{if(l)throw c}}if("child"===r){var s=t.calcPathAppend(n.path,t.indexToPath(this.getChildren(n).length+1));this.updatePath(e,s)}else if("left"===r||"right"===r){var s="left"===r?n.path:t.calcPathShift(n.path,1);this.updatePath(e,s);var v=!0,y=!1,p=void 0;try{for(var g,m=this.getSiblings(n)[Symbol.iterator]();!(v=(g=m.next()).done);v=!0){var b=g.value;t.getPathIndex(b.path)>=t.getPathIndex(newNodePath)&&this.updatePath(b,t.calcPathShift(b.path,1))}}catch(f){y=!0,p=f}finally{try{!v&&m["return"]&&m["return"]()}finally{if(y)throw p}}}var P=!0,w=!1,R=void 0;try{for(var E,k=i[Symbol.iterator]();!(P=(E=k.next()).done);P=!0){var b=E.value;t.getPathIndex(b.path)>t.getPathIndex(a)&&this.updatePath(b,t.calcPathShift(b.path,-1))}}catch(f){w=!0,R=f}finally{try{!P&&k["return"]&&k["return"]()}finally{if(w)throw R}}}},{key:"dfs",value:function(t,e){e.push(t);var n=!0,r=!1,a=void 0;try{for(var i,o=this.getChildren(t)[Symbol.iterator]();!(n=(i=o.next()).done);n=!0){var l=i.value;this.dfs(l,e)}}catch(c){r=!0,a=c}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw a}}}},{key:"updatePath",value:function(t,e){var n=getDescendants(t),r=!0,a=!1,i=void 0;try{for(var o,l=n[Symbol.iterator]();!(r=(o=l.next()).done);r=!0){var c=o.value,u=e+c.path.substr(t.path.length);this.getRefById(c.id).update({path:u})}}catch(h){a=!0,i=h}finally{try{!r&&l["return"]&&l["return"]()}finally{if(a)throw i}}this.getRefById(t.id).update({path:e})}}],[{key:"calcPathShift",value:function(e,n){return e.substr(0,e.length-4)+t.indexToPath(t.getPathIndex(e)+n)}},{key:"calcPathAppend",value:function(t,e){return t+e}},{key:"getDepth",value:function(t){return t.length/4}},{key:"getPathAtDepth",value:function(t,e){return t.substr(0,4*e)}},{key:"getParentPath",value:function(t){return t.path.substr(0,t.path.length-4)}},{key:"getPathIndex",value:function(t,e){return e?parseInt(t.substr(4*(e-1),4)):parseInt(t.substr(t.length-4))}},{key:"indexToPath",value:function(t){return(1e4+t).toString().substr(1)}}]),t}();n.GCCIModel=i},{}]},{},[1]);